...
- **[watermarks-remover](https://github.com/guillaumemeyer/watermarks-remover)** by Guillaume Meyer — multi-vendor AI provenance mark removal covering invisible Unicode (Layer A), statistical text watermarks via rewrite (Layer B), and C2PA/EXIF/XMP/container metadata across PNG/JPEG/WebP/SVG/PDF/DOCX/ODT/HTML/MD; thin HTTP client skill architecture with optional Docker backends; inspired the `/remove-ai-marks` skill
